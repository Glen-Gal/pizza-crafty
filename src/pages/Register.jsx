...
const Register = () => {
  ...
  const [errors, setErrors] = useState({
    ...
    confirmPassword: null, // Set initial errors to null
  });
      ...
      <div className="bg-black/75 backdrop-blur-md rounded-lg p-8 w-full md:w-96 text-center shadow-lg text-sm">
        ...
        <form>
          ...
          <div className="mb-3">
            ...
            <p
              className={`text-red-500 text-left text-xs ${
                errors.confirmPassword ? "" : "opacity-0"
              }`}
            >
              {errors.confirmPassword ? errors.confirmPassword : "Error Place"}
            </p>
          </div>
          <div className="buttons w-full flex justify-between">
            <Link to="/pizzacrafty" className="w-full">
              <button
                type="submit"
